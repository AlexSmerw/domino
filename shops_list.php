...
<html>
<head>
<title>Free Furniture Mall Website Template | Gallery :: w3layouts</title>
  ...
  <div class="header">
		 <div class="header_top">
		 	 <div class="wrap">
	    		...
	    		<div class="logo">
						<a href="index.html"><h1><span>F</span>urniture <span>M</span>all</h1></a>
					</div>				    
              </div>		
   <div class="wrap">
   	 <div class="main">
	    <div class="content">
			<h2>Магазины на территории ТЦ Домино</h2>
			<!--<div class="questions">
	    	...
	    	<div class="section group">
				<div class="grid_1_of_4 images_1_of_4">
					 ...
					 <h3>Стул и стол</h3>
					 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua<span><a href="shop.php">[...]Подробнее</a></span></p>
				</div>
				<div class="grid_1_of_4 images_1_of_4">
					 ...
					 <h3>Диваныч</h3>
					 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua<span><a href="shop.php">[...]</a></span></p>
				</div>
				<div class="grid_1_of_4 images_1_of_4">
			...
			<div class="section group">
				<div class="grid_1_of_4 images_1_of_4">
					 <a class="fancybox" href="web/images/gallery-img5.jpg" data-fancybox-group="gallery" title="Sed vel sapien vel sem uno"><img src="web/images/gallery-img5.jpg" alt=""/><span> </span></a>
					 <h3>Product Name</h3>
					 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua<span><a href="shop.php">[...]</a></span></p>
				</div>
				<div class="grid_1_of_4 images_1_of_4">
					  <a class="fancybox" href="web/images/gallery-img6.jpg" data-fancybox-group="gallery" title="Sed vel sapien vel sem uno"><img src="web/images/gallery-img6.jpg" alt=""/><span> </span></a>
					 <h3>Product Name</h3>
					 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua<span><a href="shop.php">[...]</a></span></p>
				</div>
				<div class="grid_1_of_4 images_1_of_4">
					  <a class="fancybox" href="web/images/gallery-img7.jpg" data-fancybox-group="gallery" title="Sed vel sapien vel sem uno"><img src="web/images/gallery-img7.jpg" alt=""/><span> </span></a>
					<h3>Product Name</h3>
					 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua<span><a href="shop.php">[...]</a></span></p>
				</div>
				<div class="grid_1_of_4 images_1_of_4">
					  <a class="fancybox" href="web/images/gallery-img8.jpg" data-fancybox-group="gallery" title="Sed vel sapien vel sem uno"><img src="web/images/gallery-img8.jpg" alt=""/><span> </span></a>
					 <h3>Product Name</h3>
					 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua<span><a href="shop.php">[...]</a></span></p>
				</div>
			</div>	   
