...
<html>
<head>
<title>Free Furniture Mall Website Template | About :: w3layouts</title>
	    ...
	    <div class="content">
	    	...
	    	<div class="section group">
				<div class="cont span_2_of_3">
				       ...
				       <div class="about-img">
				       	<img src="web/images/about-img.jpg" alt=""/>
				       </div>
				       ...
				       <div class="questions">
	        				...
	        				<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
			        		   ...
			        		   <div class="questions">
									<h4>2.What is Lorem Ipsum dummy text ever since the 1500s?</h4>
			        				<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
			        			</div>				    
				   </div>
				   	<div class="questions">
						<h4>3.What is Lorem Ipsum typesetting industry?</h4>
	        			<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.</p>
	       			 </div>
	       			 <div class="questions">
						<h4>4.What is Lorem Ipsum typesetting industry?</h4>
	        			<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.</p>
	       			 </div>
				</div>
				<div class="rsidebar sidebar">
				      <h2>What we Offer</h2>
				       <ul>
		  						...
		  						<li>The wise man therefore in culpa qui</li>
		  						<li>Sunt in culpa qui officia culpa qui</li>
		  						<li>Lorem ipsum dolor sit amet qui officia</li>
		  						<li>Duis aute irure dolor in culpa qui</li>
		  				</ul>
