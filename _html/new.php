        ...
        <div class="content" style="padding: 0px;">
            ...
            <div class="section group">
                <div class="cont span_2_of_3">
                    ...
                    <img src="web/images/about-img.jpg"  class="new-image-float-left" alt=""/>
                ...
                <div class="rsidebar sidebar">
                    <h2>Магаизны ТЦ Домино</h2>

                    <ul>
                        <li class="no-link-li" ><span>Диваныч</span> </li>
                        <li class="no-link-li" ><span>Стол и Стул</span> </li>
                        <li class="no-link-li"><span>Диваныч</span> </li>
                        <li class="no-link-li" ><span>Диваныч</span> </li>
                        <li class="no-link-li" ><span>Диваныч</span> </li>
                    </ul>
