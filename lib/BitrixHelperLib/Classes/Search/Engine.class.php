...
class Engine
{
    protected $defaultClassName = '\BitrixHelperLib\Classes\Search\Result';
    protected $className = '\BitrixHelperLib\Classes\Search\Result';
     ...
     * @param null $offset
     * @param null $limit
     * @return \BitrixHelperLib\Classes\Search\Result[];
     */
    ...
    {
        return \BitrixHelperLib\Classes\Services\YandexSpeller::correctText($query);
    }
    ...
    public function getPagingObject($urlTemplate)
    {
        ...
        $paging = new \BitrixHelperLib\paging($this->arNavStartParams['iNumPage'], $this->total, $this->arNavStartParams['nPageSize']);
