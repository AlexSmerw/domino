...
class Manager
{
    ...
    /**
     * @var \BitrixHelperLib\Classes\Cache\Engine
     */
    private $engine;
    ...
    public function setEngine(\BitrixHelperLib\Classes\Cache\Engine $engine)
    {
        $this->engine = $engine;
    }
    ...
    {
        return self::$enabled;
//        return isset(self::$enabled) ? self::$enabled : \BitrixHelperLib\Classes\Registry::bitrixCacheEnabled();
    }
