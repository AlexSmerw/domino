...
class Object extends \BitrixHelperLib\Classes\Base\Object
{
    ...
    /**
     * @var \BitrixHelperLib\Classes\Infoblock\Object
     */
    protected $infoblock;
    ...
    /**
     * @return \BitrixHelperLib\Classes\Block\Image[]
     */
    ...
    /**
     * @param $key
     * @return \BitrixHelperLib\Classes\Block\Getter
     */
...
//                'IBLOCK_ID' => $prop['LINK_IBLOCK_ID']
    ...
    public function save()
    {
        ...
        $blockFields = \BitrixHelperLib\Classes\Infoblock\Getter::instance()->getById($this->IBLOCK_ID)->getFields();
        $blockProperties = \BitrixHelperLib\Classes\Infoblock\Getter::instance()->getById($this->IBLOCK_ID)->getProperties();
    ...
    /**
     * @return \BitrixHelperLib\Classes\Infoblock\Object|Object
     */
    function getInfoblock()
    {
        if (!isset($this->infoblock))
        {
            $this->infoblock = \BitrixHelperLib\Classes\Infoblock\Getter::instance()->getById($this->iblock_id);
        }
