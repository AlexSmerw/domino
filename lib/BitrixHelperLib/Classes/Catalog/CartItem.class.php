...
{
    protected $container;
    protected $productClassName = '\BitrixHelperLib\Classes\Catalog\Product';

    /**
     * @var \BitrixHelperLib\Classes\Catalog\Cart
     */
    protected $cart;

    /**
     * @var \BitrixHelperLib\Classes\Block\Object
     */
    protected $product;

    public function __construct($data = array(), \BitrixHelperLib\Classes\Catalog\Cart $cart)
    {
        $this->container = $data;
        $this->cart = $cart;
    }
    ...
    public function getProduct($className = null)
    {
        if (!isset($this->product))
        {
            ...
            $this->product = \BitrixHelperLib\Classes\Block\Getter::instance()
