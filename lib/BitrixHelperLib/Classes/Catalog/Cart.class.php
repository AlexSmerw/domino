...
class Cart
{
    protected $itemClass = '\BitrixHelperLib\Classes\Catalog\CartItem';
    protected $itemsRaw;
    protected $items;
...
//            'USER_DESCRIPTION' => $this->getUser()['PERSONAL_STREET'],
    ...
    public function fromOrder(\BitrixHelperLib\Classes\Catalog\Order $order, $location)
    {
    ...
    /**
     * @param $productId
     * @return \BitrixHelperLib\Classes\Catalog\CartItem
     */
